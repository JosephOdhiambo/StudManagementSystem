...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2022 at 06:35 AM
...
INSERT INTO `users` (`user_code`, `username`, `u_type`, `password`) VALUES
(1, 'Joseph Modi', 1, '123456789'),
(2, 'Kanye West', 0, 'panda'),
(3, 'taboo', 1, 'jsgjfjdhwekrkwerj');
...
--
ALTER TABLE `users`
  MODIFY `user_code` int(23) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
